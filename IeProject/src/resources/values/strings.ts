export const TEXTO_BOAS_VINDAS_TELA_INICIAL = 'no aplicativo X-Ray Classification você pode selecionar fotos dos seus raios-X, para que nossa IA te diagnostique.';
